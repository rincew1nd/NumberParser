    ...
    public class Translator
    {
        ...
        public Translator()
        {
            ErrorDic = new Dictionary<string, string>{
                ...
                {"afterWordsAfterAfterWords" , "Два числа десятичного формата подряд.\r\n"},
                {"dozenWordsAfterAfterWords" , "Числа формата 10-19 после чисел десятичного формата.\r\n"},
                {"hundredAfterAfterWords" , "hundred после чисел десятичного формата.\r\n"},
                {"unitsWordsAfterDozenWords" , "Числа единичного формата после чисел формата 10-19.\r\n"},
                {"afterWordsAfterDozenWords" , "Числа десятичного формата после чисел формата 10-19.\r\n"},
                {"dozenWordsAfterDozenWords" , "Два числа формата 10-19 подряд.\r\n"},
                {"hundredAfterDozenWords" , "hundred после чисел формата 10-19.\r\n"},
